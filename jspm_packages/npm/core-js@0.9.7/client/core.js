  ...
  !function(undefined) {
    ...
    (function(modules) {
      ...
      var date = new Date(-5e13 - 1),
          brokenDate = !(date.toISOString && date.toISOString() == '0385-07-25T07:06:39.999Z' && __webpack_require__(72)(function() {
      ...
      var $ = __webpack_require__(62),
          ...
          $def = __webpack_require__(65),
          toLength = $.toLength;
      $def($def.P + $def.F * !__webpack_require__(72)(function() {
        'q'.endsWith(/./);
      ...
      var $def = __webpack_require__(65);
      $def($def.P, 'String', {repeat: __webpack_require__(80)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var $ = __webpack_require__(62),
          cof = __webpack_require__(64),
      ...
      'use strict';
      var strong = __webpack_require__(88);
      __webpack_require__(89)('Set', {add: function add(value) {
      ...
      __webpack_require__(89)('WeakSet', {add: function add(value) {
      ...
      var $def = __webpack_require__(65);
      $def($def.S, 'RegExp', {escape: __webpack_require__(71)(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)});
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(62),
          $def = __webpack_require__(65),
          ownKeys = __webpack_require__(91);
      ...
      $def($def.P + $def.F, 'Function', {part: __webpack_require__(94)});
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(62),
          $def = __webpack_require__(65),
          ownKeys = __webpack_require__(91);
      ...
      function setStatics(keys, length) {
        $.each.call(keys.split(','), function(key) {
          if (length == undefined && key in $Array)
            ...
            statics[key] = __webpack_require__(81)(Function.call, [][key], length);
        });
      }
      ...
      module.exports = function(name) {
        return store[name] || (store[name] = global.Symbol && global.Symbol[name] || __webpack_require__(68).safe('Symbol.' + name));
      };
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(62),
          assert = __webpack_require__(69);
      ...
      module.exports = function(NAME, methods, common, IS_MAP, IS_WEAK) {
        ...
        if (!$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)) {
          ...
          var inst = new C,
              ...
              buggyZero;
          if (!__webpack_require__(83)(function(iter) {
            new C(iter);
          })) {
            C = function() {
